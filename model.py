...
class LayerNormalization(nn.Module):
    ...
    def __init__(self, eps: float = 10**-6) -> None:
        ...
        self.alpha = nn.Parameter(
            torch.ones(1)
        )  # alpha is a learnable parameter | nn.Parameter is used to make a model parameter
...
class FeedForwardBlock(nn.Module):
    # Feed forward FC-NN block of transformer encoder. d_model is dimension of the embedding. d_ff is twice of d_model to implement expand and squueze NN block.
